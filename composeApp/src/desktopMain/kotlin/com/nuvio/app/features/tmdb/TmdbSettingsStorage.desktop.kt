...
internal actual object TmdbSettingsStorage {
    ...
    private val store = DesktopKeyValueStore("nuvio_tmdb_settings")
    ...
    actual fun loadLanguage(): String? = store.getString(ProfileScopedKey.of(languageKey))
    actual fun saveLanguage(language: String) = store.putString(ProfileScopedKey.of(languageKey), language)
